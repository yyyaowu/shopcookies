...
$(function(){
	$(document).on("click", ".topSave", function(){
		...
		var old = $(this).text();
		var obj = this;
		$.post("/shopcookies_war_exploded/admin/topSave", {"goodId": goodid, "type": type}, function(data){
			if(data=="ok"){
	...
	$(document).on("click", ".topDelete", function(){
		...
		var old = $(this).text();
		var obj = this;
		$.post("/shopcookies_war_exploded/admin/topDelete", {"goodId": goodid, "type": type}, function(data){
			if(data=="ok"){
